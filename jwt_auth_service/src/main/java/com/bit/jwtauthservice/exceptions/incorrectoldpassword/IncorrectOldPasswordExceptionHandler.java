...
@ControllerAdvice
public class IncorrectOldPasswordExceptionHandler {
    @ExceptionHandler(IncorrectOldPasswordException.class)
    public ResponseEntity<ErrorDetails> incorrectOldPasswordExceptionHandler(IncorrectOldPasswordException ex) {
